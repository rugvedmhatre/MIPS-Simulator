...
int main()
{
  ...
  while (1)  // TODO: implement!
  {
    ...
    if (InstructionType == 'R') {
      ...
      RdReg1 = bitset<5>(InstructionString.substr(6,5));
      cout << "Read Register 1  : " << RdReg1 << endl;
      // In I-type Instructions, RdReg2 is not required, however we require values from ReadData2 in Store instructions, hence we pass WrtReg here...
      RdReg2 = bitset<5>(InstructionString.substr(11,5));
      // cout << "Read Register 2  : " << RdReg2 << endl;
    ...
    if (InstructionType == 'R') {
      ...
      cout << "" << endl;
      cout << "   - Execution -  " << endl;
      // Comparing whether the operands are equal by checking whether the substraction of both operands is equal to 0
      cout << "Register 1 Data  : " << myRF.ReadData1 << endl;
      cout << "Register 2 Data  : " << myRF.ReadData2 << endl;
